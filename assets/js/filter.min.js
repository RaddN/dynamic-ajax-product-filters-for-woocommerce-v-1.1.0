...
(function ($) {
    ...
    function renderAjaxHTML(response, currentUrl, url) {
        ...
        if ($targetsProducts.length) {
            if (isAppendMode) {
                ...
                const html = $effectiveSrcProducts.length ? $effectiveSrcProducts.eq(0).html() : '<p class="woocommerce-info">' + escapeHtml(TEXTS.no_products) + '</p>';
    ...
    function saveCollapseState() {
        ...
        $(".filter-group").each(function (index) {
            const $group = $(this);
            const $title = $group.find(".title");
            const $items = $group.children().not(".title");
 ...
 */
    ...
    function initializeCollapsible() {
        $(".title").each(function () {
            ...
            const mobileBP = window.__dapfforwc_mobile_bp || 768;
            ...
            if ($form.length && $form.data("mobile-style") === "style_1" && $(window).width() <= mobileBP) {
                $items.addClass("dapfforwc-hidden-important");

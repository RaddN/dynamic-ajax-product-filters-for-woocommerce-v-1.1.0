...
(function ($) {
    ...
    function renderAjaxHTML(response, currentUrl, url) {
        ...
        // Sync form state from URL parameters
        if ($updatedForm.length) {
            syncFormStateFromUrl($updatedForm, url);
        }
    ...
    function syncFormStateFromUrl($form, url) {
        try {
            ...
            for (const [key, value] of params.entries()) {
                ...
                if (['gm_pf_fragment', 'paged', 'product-page', 'orderby', 'per_page', 'operator_second', 'order'].includes(key)) {
                    continue;
                }

                // Handle search field
                if (key === 'plugincy_search') {

...
(function ($) {
    ...
    function attachPaginationEvents() {
        ...
        $(document).on('click', `${pagination_selector} a`, function (e) {
            ...
            let page = urlParams.get('page') || urlParams.get('product-page');
            if (!page) {
    ...
    function renderAjaxHTML(response, currentUrl, url) {
        ...
        const $targetsPaginations = $(pagination_selector);
        if ($targetsPaginations.length) {
            const pg = $srcPaginations.length ? $srcPaginations.eq(0).html() : '';
            $targetsPaginations.each(function (i) {
                $(this).html($srcPaginations.length > 1 ? $srcPaginations.eq(i).html() : pg);
            });
        }
    ...
    function initPriceRangeInputs() {
        ...
        $rangeInputs.off('.pf').on("input.pf", function () {
            ...
            $range.css({
                ...
                'right': 100 - (maxVal / maxPriceDefault) * 100 + "%"
            });
        });

...
(function ($) {
    ...
    function injectTooltipStyles() {
        ...
        style.textContent = ".dapfforwc-tooltip-bubble{position:absolute;z-index:9999;max-width:240px;padding:8px 10px;background:#111;color:#fff;font-size:12px;line-height:1.4;border-radius:6px;box-shadow:0 6px 18px rgba(0,0,0,0.18);pointer-events:auto}";
        document.head.appendChild(style);
    }

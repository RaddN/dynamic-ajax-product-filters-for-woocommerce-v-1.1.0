...
(function ($) {
    ...
    function filterOutDefaultDimensionRanges(formArray, $form = null) {
        ...
        dimensionRanges.forEach(([minName, maxName]) => {
            ...
            const currentMinRaw = ((($minInput.val && $minInput.val()) ?? '') + '').trim();
            const currentMaxRaw = ((($maxInput.val && $maxInput.val()) ?? '') + '').trim();
            const currentMin = currentMinRaw === '' ? defaultMin : currentMinRaw;
            const currentMax = currentMaxRaw === '' ? defaultMax : currentMaxRaw;

...
<?php
        ...
        foreach ($attributes as $attribute_name => $attribute_terms) {
            ...
            if ($terms) {
                ...
                $formOutPut .= '<div id="' . esc_attr($attribute_name) . '" class="filter-group ' . esc_attr($attribute_name) . '" style="display: ' . (!empty($dapfforwc_options['show_attributes']) ? 'block' : 'none !important') . ';">
                            <div class="title plugincy_collapsable_' . esc_attr($minimizable) . '"><span>' . (($dapfforwc_styleoptions["widget_title"] && $dapfforwc_styleoptions["widget_title"][$attribute_name] && $dapfforwc_styleoptions["widget_title"][$attribute_name] !=="") ? esc_html($dapfforwc_styleoptions["widget_title"][$attribute_name]) : esc_html($attribute_name)) . ' ' . ($singlevalueattrSelect === "yes" ? ' <span class="reset-value">reset</span>' : '') . '</span>' .
    ...
    if (!empty($brands)) {
        ...
        $formOutPut .= '<div id="brands" class="filter-group brands" style="display: ' . (!empty($dapfforwc_options['show_brand']) ? 'block' : 'none !important') . ';"><div class="title plugincy_collapsable_' . esc_attr($minimizable) . '"><span>' . (($dapfforwc_styleoptions["widget_title"] && $dapfforwc_styleoptions["widget_title"]["brands"] && $dapfforwc_styleoptions["widget_title"]["brands"] !=="") ? esc_html($dapfforwc_styleoptions["widget_title"]["brands"]) : esc_html__('Brands', 'dynamic-ajax-product-filters-for-woocommerce')) . ($singlevalueSelect === "yes" ? ' <span class="reset-value">reset</span>' : '') . '</span>' . ($minimizable === "arrow" || $minimizable === "minimize_initial" ? '<div class="collaps"><svg class="rotatable" xmlns="https://www.w3.org/2000/svg" viewBox="0 0 448 512" role="graphics-symbol" aria-hidden="false" aria-label=""><path d="M224 416c-8.188 0-16.38-3.125-22.62-9.375l-192-192c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0L224 338.8l169.4-169.4c12.5-12.5 32.75-12.5 45.25 0s12.5 32.75 0 45.25l-192 192C240.4 412.9 232.2 416 224 416z"></path></svg></div>' : '') . '</div>';
        if ($sub_option === 'color_circle' || $sub_option === 'color_value') {
            $sub_option = 'color';
        } elseif ($sub_option === 'button_check') {
            $sub_option = '';
    ...
    if (!empty($authors)) {
        ...
        $formOutPut .= '<div id="authors" class="filter-group authors" style="display: ' . (!empty($dapfforwc_options['show_author']) ? 'block' : 'none !important') . ';"><div class="title plugincy_collapsable_' . esc_attr($minimizable) . '"><span>' . (($dapfforwc_styleoptions["widget_title"] && $dapfforwc_styleoptions["widget_title"]["authors"] && $dapfforwc_styleoptions["widget_title"]["authors"] !=="") ? esc_html($dapfforwc_styleoptions["widget_title"]["authors"]) : esc_html__('Authors', 'dynamic-ajax-product-filters-for-woocommerce')) . ($singlevalueSelect === "yes" ? ' <span class="reset-value">reset</span>' : '') . '</span>' . ($minimizable === "arrow" || $minimizable === "minimize_initial" ? '<div class="collaps"><svg class="rotatable" xmlns="https://www.w3.org/2000/svg" viewBox="0 0 448 512" role="graphics-symbol" aria-hidden="false" aria-label=""><path d="M224 416c-8.188 0-16.38-3.125-22.62-9.375l-192-192c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0L224 338.8l169.4-169.4c12.5-12.5 32.75-12.5 45.25 0s12.5 32.75 0 45.25l-192 192C240.4 412.9 232.2 416 224 416z"></path></svg></div>' : '') . '</div>';
        if ($sub_option === 'color_circle' || $sub_option === 'color_value') {
            $sub_option = 'color';
        } elseif ($sub_option === 'button_check') {
            $sub_option = '';
    ...
    if (!empty($status)) {
        ...
        $formOutPut .= '<div id="status" class="filter-group status" style="display: ' . (!empty($dapfforwc_options['show_status']) ? 'block' : 'none !important') . ';"><div class="title plugincy_collapsable_' . esc_attr($minimizable) . '"><span>' . (($dapfforwc_styleoptions["widget_title"] && $dapfforwc_styleoptions["widget_title"]["status"] && $dapfforwc_styleoptions["widget_title"]["status"] !=="") ? esc_html($dapfforwc_styleoptions["widget_title"]["status"]) : esc_html__('Stock Status', 'dynamic-ajax-product-filters-for-woocommerce')) . ($singlevalueSelect === "yes" ? ' <span class="reset-value">reset</span>' : '') . '</span>' . ($minimizable === "arrow" || $minimizable === "minimize_initial" ? '<div class="collaps"><svg class="rotatable" xmlns="https://www.w3.org/2000/svg" viewBox="0 0 448 512" role="graphics-symbol" aria-hidden="false" aria-label=""><path d="M224 416c-8.188 0-16.38-3.125-22.62-9.375l-192-192c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0L224 338.8l169.4-169.4c12.5-12.5 32.75-12.5 45.25 0s12.5 32.75 0 45.25l-192 192C240.4 412.9 232.2 416 224 416z"></path></svg></div>' : '') . '</div>';
        if ($sub_option === 'color_circle' || $sub_option === 'color_value') {
            $sub_option = 'color';
        } elseif ($sub_option === 'button_check') {
            $sub_option = '';
    ...
    if (!empty($sale_status)) {
        ...
        $formOutPut .= '<div id="sale_status" class="filter-group sale_status" style="display: ' . (!empty($dapfforwc_options['show_onsale']) ? 'block' : 'none !important') . ';"><div class="title plugincy_collapsable_' . esc_attr($minimizable) . '"><span>' . (($dapfforwc_styleoptions["widget_title"] && $dapfforwc_styleoptions["widget_title"]["sale_status"] && $dapfforwc_styleoptions["widget_title"]["sale_status"] !=="") ? esc_html($dapfforwc_styleoptions["widget_title"]["sale_status"]) : esc_html__('Sale Status', 'dynamic-ajax-product-filters-for-woocommerce')) . ($singlevalueSelect === "yes" ? ' <span class="reset-value">reset</span>' : '') . '</span>' . ($minimizable === "arrow" || $minimizable === "minimize_initial" ? '<div class="collaps"><svg class="rotatable" xmlns="https://www.w3.org/2000/svg" viewBox="0 0 448 512" role="graphics-symbol" aria-hidden="false" aria-label=""><path d="M224 416c-8.188 0-16.38-3.125-22.62-9.375l-192-192c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0L224 338.8l169.4-169.4c12.5-12.5 32.75-12.5 45.25 0s12.5 32.75 0 45.25l-192 192C240.4 412.9 232.2 416 224 416z"></path></svg></div>' : '') . '</div>';
        if ($sub_option === 'color_circle' || $sub_option === 'color_value') {
            $sub_option = 'color';
        } elseif ($sub_option === 'button_check') {
            $sub_option = '';
    ...
    if ($show_any_dimension) {
        ...
        $formOutPut .= (($dapfforwc_styleoptions["widget_title"] && $dapfforwc_styleoptions["widget_title"]["dimensions"] && $dapfforwc_styleoptions["widget_title"]["dimensions"] !=="") ? esc_html($dapfforwc_styleoptions["widget_title"]["dimensions"]) : esc_html__('Dimensions', 'dynamic-ajax-product-filters-for-woocommerce'));
    ...
    if (!empty($show_sku)) {
        ...
        $formOutPut .= '<div class="title plugincy_collapsable_' . esc_attr($minimizable) . '">';
        $formOutPut .= (($dapfforwc_styleoptions["widget_title"] && $dapfforwc_styleoptions["widget_title"]["sku"] && $dapfforwc_styleoptions["widget_title"]["sku"] !=="") ? esc_html($dapfforwc_styleoptions["widget_title"]["sku"]) : esc_html__('SKU', 'dynamic-ajax-product-filters-for-woocommerce'));
    ...
    if (!empty($show_discount)) {
        ...
        $formOutPut .= '<div class="title plugincy_collapsable_' . esc_attr($minimizable) . '">';
        $formOutPut .= (($dapfforwc_styleoptions["widget_title"] && $dapfforwc_styleoptions["widget_title"]["discount"] && $dapfforwc_styleoptions["widget_title"]["discount"] !=="") ? esc_html($dapfforwc_styleoptions["widget_title"]["discount"]) : esc_html__('Minimum Discount (%)', 'dynamic-ajax-product-filters-for-woocommerce'));
    ...
    if (!empty($show_date_filter)) {
        ...
        $formOutPut .= '<div class="title plugincy_collapsable_' . esc_attr($minimizable) . '">';
        $formOutPut .= (($dapfforwc_styleoptions["widget_title"] && $dapfforwc_styleoptions["widget_title"]["date_filter"] && $dapfforwc_styleoptions["widget_title"]["date_filter"] !=="") ? esc_html($dapfforwc_styleoptions["widget_title"]["date_filter"]) : esc_html__('Date Filter', 'dynamic-ajax-product-filters-for-woocommerce'));

                        ...
                        function (tab) {
                            if (tab.name === 'general') {
                                ...
                                attributes.filterType === 'all' && el(PanelBody, { title: 'Database Query', initialOpen: false },
                                    el('p', { style: { fontSize: '11px',color: '#666666' } }, 'If this is not a product archive page & you are not using [products] shortcode to display products, you can use these options to query options.'),

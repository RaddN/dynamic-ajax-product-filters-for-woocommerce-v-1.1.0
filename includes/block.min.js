...
(function (blocks, element, editor, components) {
    ...
    blocks.registerBlockType('plugin/dynamic-ajax-filter', {
        ...
        attributes: {
            filterOptions: {
                type: 'array', default: [
                    ...
                    { id: 'brands', title: 'Brands', visible: true },
                    { id: 'authors', title: 'Authors', visible: true },
                    { id: 'status', title: 'Status', visible: true },
                    { id: 'sale_status', title: 'Sale Status', visible: true },
                    { id: 'dimensions', title: 'Dimensions', visible: true },
                    { id: 'sku', title: 'SKU', visible: true },
                    { id: 'discount', title: 'Discount', visible: true },
                    { id: 'date_filter', title: 'Date Filter', visible: true },
                ]
            },
            filterType: storestring(defaultvalue = 'all'),
            filterLayout: storestring(defaultvalue = 'sidebar'),
            ...
            tag: storestring(),
            attribute: storestring(),
            attributeTerms: storestring(),
        ...
        edit: function (props) {
            ...
            const [filterOptions, setFilterOptions] = useState(attributes.filterOptions || ['search_text', 'rating', 'price-range', "product-category", 'tag']);
                            ...
                            if (tab.name === 'general') {
                                return [el(PanelBody, { title: 'Filter Settings' },
                                    ...
                                    attributes.filterType === 'all' && el(SelectControl, {
                                        label: 'Redirect When Products Missing (Pro)',
                                        value: attributes.redirectShop,
                                        options: [
                                            { label: 'No (Pro)', value: 'no', disabled: true},
                                            { label: 'Yes (Pro)', value: 'yes', disabled: true},
                                        ],
                                        onChange: function (value) {
                                            setAttributes({ redirectShop: value });
                                        }
                                    }),
                                   attributes.filterType === 'all' && el(SelectControl, {
                                        label: 'Filter Layout',
                                        ...
                                        options: [
                                            ...
                                            { label: 'Top View', value: 'top_view' },
                                            { label: 'Top View Wrap (Pro)', value: 'top_view_wrap', disabled: true },
                                            { label: 'Popup (Pro)', value: 'popup', disabled: true },
                                            { label: 'Popup Horizontal Wrap (Pro)', value: 'popup_horizontal_wrap', disabled: true },
                                            { label: 'Drawer (Pro)', value: 'drawer', disabled: true }
                                        ],
                                        onChange: function (value) {
                                    ...
                                    attributes.filterType === 'all' && el(SelectControl, {
                                        ...
                                        onChange: function (value) {
                                            setAttributes({ drawerPosition: value });
                                        }
                                    }),
                                    attributes.filterType === 'all' && el(SelectControl, {
                                        label: 'Collapsable Filters (Pro)',
                                        value: attributes.collapsable,
                                        options: [
                                ...
                                // database query sections for filter options
                                attributes.filterType === 'all' && el(PanelBody, { title: 'Database Query', initialOpen: false },
                                    el('p', { style: { fontSize: '11px',color: '#666666' } }, 'Our plugin will automatically detect your query. If the automatic detection is incorrect and displays irrelevant filter options, please configure the database accordingly.'),
                                    // category query (comma separated)
                                    el(TextControl, {
                                        label: 'Categories',
                                    ...
                                    el('p', { style: { fontSize: '11px', color: '#666666' } }, 'Use Category slugs, comma separated.'),
                                    // tag query (comma separated)
                                    el(TextControl, {
                                        label: 'Tags',
                                    ...
                                    el('p', { style: { fontSize: '11px', color: '#666666' } }, 'Use Tag slugs, comma separated.'),
                                    // attribute slug input
                                    el(TextControl, {
                                        label: 'Attribute',
                                    ...
                                    // attribute terms input (comma separated)
                                    el(TextControl, {
                                        label: 'Attribute Terms',
                                        value: attributes.attributeTerms || '',
                                        onChange: function (value) {
                                            setAttributes({ attributeTerms: value });
                                        }
                                    }),
                                    el('p', { style: { fontSize: '11px', color: '#666666' } }, 'Use Attribute terms slugs, comma separated.'),
                                ),
                                attributes.filterType === 'all' && el(
                                    PanelBody,
                                ...
                                attributes.filterType === 'all' && el(PanelBody, { title: "Mobile Responsive Style", initialOpen: false },
                                    el(SelectControl, {
                                        label: 'Style Type',
                                ...
                                if (attributes.filterType === 'all') {
                                    return [
                                        attributes.mobileStyle === 'style_1' && el(PanelBody, { title: 'Filter Word (Mobile)', initialOpen: true },
                                        ...
                                        el(PanelBody, { title: 'Slider Style', initialOpen: false },
                                            ...
                                            el('p', {}, 'plugrogress Border Radius', el(DeviceSelector, {
                                                onChange: function (device) {
                                                    setAttributes({ selectedDevice: device });
                                                }
                                            })),
                                            el(CustomBoxControl, {
                                                values: attributes.sliderStyle[attributes.selectedDevice] ? attributes.sliderStyle[attributes.selectedDevice]["plugrogress-border-radius"] : { top: 0, right: 0, bottom: 0, left: 0 },
                                                unit: 'px',
                                                onChange: function (value) {
                                                    handleCustomBoxControl(value, 'sliderStyle', "plugrogress-border-radius");
                                                }
                                            }),
                                            el('p', {}, 'plugrogress Margin', el(DeviceSelector, {
                                                onChange: function (device) {
                                                    setAttributes({ selectedDevice: device });
                                                }
                                            })),
                                    ...
                                    return [
                                        ...
                                        el(PanelBody, { title: 'Hover Style', initialOpen: false },
                                            ...
                                            el(ColorPalette, {
                                                ...
                                                onChange: function (value) {
                                                    handleBackgroundChange(value, 'singleFilterHoverStyle')
                                                },
                                            }),
                                            el('p', {}, 'Color'),
                                            el(ColorPalette, {
